...
class MyAcceptedAppointmentsFromQueuePage extends StatelessWidget {
  const MyAcceptedAppointmentsFromQueuePage({
    super.key,
  });
  ...
  Widget build(BuildContext context) {
    ...
    print('Current User ID: $currentUser'); // Debugging
    return Scaffold(
      body: Container(
        ...
        child: StreamBuilder<QuerySnapshot>(
          ...
          builder: (context, snapshot) {
            ...
            if (snapshot.data!.docs.isEmpty) {
              print('No documents found'); // Debugging
              return const Center(
                  child: Text('No accepted appointments from queue.'));
            }

            print(
                'Number of documents: ${snapshot.data!.docs.length}'); // Debugging
